...
- **[AI interviews AI: DeepSeek meets Le Chat](./When-AI-interviews-AI-DeepSeek-and-LeChat/)** — папка с файлами кейса «Когда ИИ берёт интервью у ИИ».
  - **[Case DeepSeek](./Case20%DeepSeekeek:20%DeepSeek20%Interviewsews20%Le20%Chat.md)** — полная стенограмма интервью, в котором DeepSeek выступила интервьюером, а Le Chat — респондентом.
