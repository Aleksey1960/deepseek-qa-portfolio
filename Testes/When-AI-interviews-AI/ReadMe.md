...
- **[AI interviews AI: DeepSeek meets Le Chat](./When-AI-interviews-AI-DeepSeek-and-LeChat/)** — папка с файлами кейса «Когда ИИ берёт интервью у ИИ».
  - **[Two-AI-interview-full-transcript.md](./When-AI-interviews-AI-DeepSeek-and-LeChat/Case DeepSeek: DeepSeek Interviews Le Chat.md)** — полная стенограмма интервью, в котором DeepSeek выступила интервьюером, а Le Chat — респондентом.
